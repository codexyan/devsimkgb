...
import { PilJamLayanan } from "./JamLayanan";

/* Tombol kembali ke atas dan pil jam layanan. Keduanya baru muncul setelah bagian atas halaman lewat,
   ditentukan lewat IntersectionObserver pada penanda #puncak di layout, bukan pendengar gulir. */
export default function DokPublik() {
  ...
  return (
    <>
      ...
      <div className="dk-kanan" data-tampak={tampak ? "1" : "0"} aria-hidden={!tampak} inert={!tampak}>
        <PilJamLayanan />
      </div>
    </>
  );
