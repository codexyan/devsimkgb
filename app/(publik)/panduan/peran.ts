...
export const PERAN: readonly Peran[] = [
  {
    ...
    bagian: ["ringkasan", "jadwal", "untuk-upt", "contoh-kasus", "status", "pertanyaan"],
  },
  {
    id: "tu",
  ...
  },
  {
    ...
    bagian: ["ringkasan", "kewenangan", "jadwal", "di-sim-kgb", "pengiriman-sk", "contoh-kasus", "status"],
  },
  {
    id: "keuangan",
    label: "Bagian keuangan",
    ringkas: "Mengonfirmasi SK dan merekon gaji di Gaji Web.",
    bagian: ["ringkasan", "jadwal", "keuangan", "pengiriman-sk", "dasar-hukum"],
  },
  {
    id: "super",
    label: "Super Admin",
  ...
  },
  {
    ...
    bagian: ["ringkasan", "jadwal", "status", "pertanyaan"],
  },
];
