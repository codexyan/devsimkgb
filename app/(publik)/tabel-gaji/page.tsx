      ...
      <header className="tb-kepala">
        ...
        <div className="tb-pengantar masuk" style={{ "--d": 180 } as React.CSSProperties}>
          <p className="pub-lead">
            Gaji pokok menurut golongan ruang dan masa kerja golongan (MKG), berlaku sejak 1 Januari 2024. Kenaikan gaji
            berkala memindahkan gaji pokok ke anak tangga berikutnya pada kolom yang sama.
          </p>
          <p className="pub-meta">
            Angka di halaman ini adalah tabel yang dipakai SIM-KGB untuk menghitung KGB. Seluruh 272 selnya dicocokkan
            dengan salinan lampiran peraturan pada 18 September 2026.
          </p>
        </div>
      </header>
