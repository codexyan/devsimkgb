// Modal aksi KGB bersama untuk /dashboard dan /dashboard/kgb.

export { default as KerangkaModal } from "./KerangkaModal";
export { default as ModalInputKgb } from "./ModalInputKgb";
export { default as ModalArsipKgb } from "./ModalArsipKgb";
export { default as ModalBatalkanKgb } from "./ModalBatalkanKgb";
export { default as ModalBuatSk, type RingkasanSk } from "./ModalBuatSk";
