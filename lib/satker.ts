...
export const SATKER: Satker[] = [
  ...
  { kode: "lapas-banjarmasin", nama: "Lapas Kelas IIA Banjarmasin", jenis: "lapas", kppn: "Banjarmasin" },
  { kode: "lapas-narkotika-karang-intan", nama: "Lapas Kelas IIA Khusus Narkotika Karang Intan", jenis: "lapas", kppn: "Banjarmasin" },
  { kode: "lapas-kotabaru", nama: "Lapas Kelas IIA Kotabaru", jenis: "lapas", kppn: "Kotabaru" },
  { kode: "lapas-perempuan-martapura", nama: "Lapas Perempuan Kelas IIA Martapura", jenis: "lapas", kppn: "Banjarmasin" },
  { kode: "lapas-amuntai", nama: "Lapas Kelas IIB Amuntai", jenis: "lapas", kppn: "Tanjung" },
  { kode: "lapas-banjarbaru", nama: "Lapas Kelas IIB Banjarbaru", jenis: "lapas", kppn: "Banjarmasin" },
  { kode: "lapas-tanjung", nama: "Lapas Kelas IIB Tanjung", jenis: "lapas", kppn: "Tanjung" },
  { kode: "lapas-batulicin", nama: "Lapas Kelas III Batulicin", jenis: "lapas", kppn: "Kotabaru" },
  { kode: "rutan-barabai", nama: "Rutan Kelas IIB Barabai", jenis: "rutan", kppn: "Barabai" },
  { kode: "rutan-kandangan", nama: "Rutan Kelas IIB Kandangan", jenis: "rutan", kppn: "Barabai" },
  { kode: "rutan-marabahan", nama: "Rutan Kelas IIB Marabahan", jenis: "rutan", kppn: "Banjarmasin" },
  { kode: "rutan-pelaihari", nama: "Rutan Kelas IIB Pelaihari", jenis: "rutan", kppn: "Pelaihari" },
  { kode: "rutan-rantau", nama: "Rutan Kelas IIB Rantau", jenis: "rutan", kppn: "Barabai" },
  { kode: "rutan-tanjung", nama: "Rutan Kelas IIB Tanjung", jenis: "rutan", kppn: "Tanjung" },
  { kode: "bapas-banjarmasin", nama: "Bapas Kelas I Banjarmasin", jenis: "bapas", kppn: "Banjarmasin" },
  { kode: "bapas-amuntai", nama: "Bapas Kelas II Amuntai", jenis: "bapas", kppn: "Tanjung" },
  { kode: "bapas-batulicin", nama: "Bapas Kelas II Batulicin", jenis: "bapas", kppn: "Kotabaru" },
  { kode: "lpka-martapura", nama: "LPKA Kelas I Martapura", jenis: "lpka", kppn: "Banjarmasin" },
];
